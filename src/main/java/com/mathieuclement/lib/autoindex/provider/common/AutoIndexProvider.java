...
public interface AutoIndexProvider {
     ...
     * @throws ProviderException           in case a problem happened with the provider, like a connection issue,
     *                                     an error returned by the server, etc.
     ...
     * @throws UnsupportedPlateException   if the given plate is not supported by this provider.
     *                                     See {@link #isPlateTypeSupported(PlateType)}
     */
     ...
     *
     * @param requestId request identifier, passed to
     *                  {@link #getPlateOwner(com.mathieuclement.lib.autoindex.plate.Plate, int)}
     */
